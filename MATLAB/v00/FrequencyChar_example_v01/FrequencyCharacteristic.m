...
STEP_TIME = 20; % [s] ; time per each freq.
...
save(datafileName, "upb", "STEP_STAB_TIME", "STEP_SIZE", "T_sample", "T_start", "STEP_TIME", "T_stop", "STEP_REPS", "nops", "u", "freq_char", "STEP_PROCESS_ORDER", "nprocessorder", "STEP_STAB_DU");
