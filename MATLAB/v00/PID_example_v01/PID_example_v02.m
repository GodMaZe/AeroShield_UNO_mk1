...
Ys = [0,             10,        20,      50,      70,         80,       90,      110,     130,      140,       150,        155,       160        170]';
Ps = [0.00925,  0.15025,    0.265,  0.325,    0.6505,     1.8505,   1.9005,   1.855,      1.785,     1.55,    1.625,     1.4495,      1.3475     1.2475]';
Is = [1.85,       2.985,      3.25,    3.65,   3.275,      1.775,    1.625,    1.525,     1.665,     1.51,    0.7225,    0.6225,      0.5235     0.2235]';
Ds = [0.02125,   0.0725,  0.105125, 0.15125, 0.255125,   0.305125,   0.355125, 0.3500125, 0.275,     0.2325,     0.23,    0.215,      0.20       0.20]';
